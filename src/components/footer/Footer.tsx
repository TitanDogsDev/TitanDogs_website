...
const Footer = () => {
    return (
        <div id="footer" className="w-full h-40 sm:h-28 flex flex-wrap justify-around items-center px-10 z-20 bg-purple-600">
            <a className="w-1/3 cursor-pointer hidden sm:block" href="/"><h1 className="flex-grow text-white whitespace-nowrap text-3xl font-bold uppercase w-full md:w-auto cursor-pointer">Titan Dogs</h1></a>
