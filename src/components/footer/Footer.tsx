...
const Footer = () => {
    return (
        <div className="w-full h-40 sm:h-28 flex justify-around items-center px-10 z-20 bg-purple-600">
            <a className="w-1/3 cursor-pointer" href="/"><h1 className="flex-grow text-white whitespace-nowrap text-3xl font-bold uppercase w-full md:w-auto cursor-pointer">Titan Dogs</h1></a>
            <a className="cursor-pointer" href="/"><img className="h-20 w-auto" src={Logo} alt="logo" /></a>
            <div className="w-1/3 flex items-center justify-end">
                <a className="cursor-pointer flex flex-row justify-center items-center" href="https://twitter.com/TitanDogsNFT" target="_blank" rel="noreferrer">
