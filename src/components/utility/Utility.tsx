import YellowTitan from "../../images/yellow_titan.png"
...
const Utility = () => {
    return (
        <div id="utility" className="w-full h-auto flex flex-col justify-center items-center bg-gradient-to-b from-gray-800 to-black text-white py-20 sm:p-20">
            <h1 className="uppercase text-4xl font-bold">Utility</h1>
            <div className="w-full flex flex-row flex-wrap justify-around items-start text-lg">
                <img className="w-96 mt-16" src={YellowTitan} alt="yellow_titan" />

                <ul className="list-none mt-16 w-140">
                    <li className="mb-6 p-10">
